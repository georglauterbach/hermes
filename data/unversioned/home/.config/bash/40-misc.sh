...
#       task  miscellaneous setup routines (environment variables,
#            completions, prompts, history, ble.sh, etc.)

# ! Do not edit this file - use ${HOME}/.config/bash/{20-custom_early,99-custom_late}.sh instead.

function __hermes__setup_early_miscellaneous() {
  # shell options
...
__hermes__setup_early_miscellaneous
unset __hermes__setup_early_miscellaneous
...
for __FUNCTION in 'completion' 'prompt' 'history'; do
